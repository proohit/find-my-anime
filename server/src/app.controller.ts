...
import { Anime, type AnimeSeason } from '@find-my-anime/shared/interfaces/AnimeDb';
...
export class AppController {
    ...
    @ApiOperation({
        description: 'Search anime by filter parameters. Default limits result to 20',
    })
    @ApiQuery({
        name: 'id',
        type: String,
    ...
    async queryAnime(
        ...
        tags?: string[],
        @Query('excludedTags', arrayQueryTransformer({ separator: ',', trim: true }))
        excludedTags?: string[],
